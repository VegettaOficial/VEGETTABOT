...
const smsRowner = () => { return `\`\`\`» 𝙀𝙎𝙏𝙀 𝘾𝙊𝙈𝘼𝙉𝘿𝙊 𝙎𝙊𝙇𝙊 𝙈𝙄 𝘾𝙍𝙀𝘼𝘿𝙊𝙍 𝙅𝙀𝙁𝙁𝙊 𝙇𝙊 𝙋𝙐𝙀𝘿𝙀 𝙐𝙎𝘼𝙍.\`\`\`` }//NUMERO DE BOT
const smsOwner = () => { return `\`\`\`» 𝙀𝙎𝙏𝙀 𝘾𝙊𝙈𝘼𝙉𝘿𝙊 𝙎𝙊𝙇𝙊 𝙈𝙄 𝘾𝙍𝙀𝘼𝘿𝙊𝙍 𝙅𝙀𝙁𝙁𝙊 𝙇𝙊 𝙋𝙐𝙀𝘿𝙀 𝙐𝙎𝘼𝙍.\`\`\`` }//OWNER
...
//_antiviewonce.js
const smsAntiView = () => { return `𝙊𝙔𝙀 𝙀𝙇𝙄𝙏𝙀 𝘽𝙊𝙏 𝙏𝙊𝘿𝙊 𝙇𝙊 𝙑𝙀 📷.`} 
...
//_expired.js
const smsBottem1 = () => { return `🕓 𝘘𝘶𝘦𝘳𝘪𝘥𝘰 𝘩𝘶𝘮𝘢𝘯𝘰 𝘴𝘦 𝘵𝘦 𝘵𝘦𝘳𝘮𝘪𝘯𝘰́ 𝘦𝘭 𝘵𝘪𝘦𝘮𝘱𝘰 𝘨𝘳𝘢𝘵𝘪𝘴 𝘥𝘦 𝘱𝘳𝘶𝘦𝘣𝘢 𝘥𝘦 𝘌𝘭𝘪𝘵𝘦 𝘉𝘰𝘵, 𝘱𝘢𝘳𝘢 𝘳𝘦𝘯𝘰𝘷𝘢𝘳 𝘦𝘭 𝘴𝘦𝘳𝘷𝘪𝘤𝘪𝘰 𝘤𝘰𝘯𝘵𝘢́𝘤𝘵𝘢𝘵𝘦 𝘤𝘰𝘯 𝘮𝘪 𝘤𝘳𝘦𝘢𝘥𝘰𝘳.
