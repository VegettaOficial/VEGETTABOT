...
//AVISOS DE MENSAJE
const smsAvisoRG = () => { return `❱❱ 𝙑𝙀𝙂𝙀𝙏𝙏𝘼 𝘽𝙊𝙏 ❰❰\n\n` } 
...
const smsAvisoEG = () => { return `❱❱ 𝙑𝙀𝙂𝙀𝙏𝙏𝘼 𝘽𝙊𝙏 ❰❰\n\n` }

//PARÁMETROS EN COMANDOS
const smsRowner = () => { return `\`\`\`» 𝙀𝙎𝙏𝙀 𝘾𝙊𝙈𝘼𝙉𝘿𝙊 𝙎𝙊𝙇𝙊 𝙈𝙄 𝘾𝙍𝙀𝘼𝘿𝙊𝙍 𝙎𝙀𝘽𝘼𝙎𝙏𝙄𝘼𝙉 𝙇𝙊 𝙋𝙐𝙀𝘿𝙀 𝙐𝙎𝘼𝙍.\`\`\`` }//NUMERO DE BOT
const smsOwner = () => { return `\`\`\`» 𝙀𝙎𝙏𝙀 𝘾𝙊𝙈𝘼𝙉𝘿𝙊 𝙎𝙊𝙇𝙊 𝙈𝙄 𝘾𝙍𝙀𝘼𝘿𝙊𝙍 𝙎𝙀𝘽𝘼𝙎𝙏𝙄𝘼𝙉 𝙇𝙊 𝙋𝙐𝙀𝘿𝙀 𝙐𝙎𝘼𝙍.\`\`\`` }//OWNER
...
const smsModAd2 = () => { return `Solo los Admins podrán usar VEGETTA BOT en Grupos`}
...
//_antiviewonce.js
const smsAntiView = () => { return `𝘽𝙍𝙊𝙏𝙃𝙀𝙍, 𝘼𝙌𝙐𝙄 𝙉𝘼𝘿𝘼 𝙎𝙀 𝙊𝘾𝙐𝙇𝙏𝘼 📷.`} 
...
//_expired.js
const smsBottem1 = () => { return `‼️ 𝘘𝘶𝘦𝘳𝘪𝘥𝘰 𝘩𝘶𝘮𝘢𝘯𝘰 𝘴𝘦 𝘵𝘦 𝘵𝘦𝘳𝘮𝘪𝘯𝘰́ 𝘦𝘭 𝘵𝘪𝘦𝘮𝘱𝘰 𝘨𝘳𝘢𝘵𝘪𝘴 𝘥𝘦 𝘱𝘳𝘶𝘦𝘣𝘢 𝘥𝘦 𝘝𝘦𝘨𝘦𝘵𝘵𝘢 𝘉𝘰𝘵, 𝘱𝘢𝘳𝘢 𝘳𝘦𝘯𝘰𝘷𝘢𝘳 𝘦𝘭 𝘴𝘦𝘳𝘷𝘪𝘤𝘪𝘰 𝘤𝘰𝘯𝘵𝘢́𝘤𝘵𝘢𝘵𝘦 𝘤𝘰𝘯 𝘮𝘪 𝘤𝘳𝘦𝘢𝘥𝘰𝘳.

👤 https://Wa.me/593992402778
Síguenos en Instagram:
» https://www.instagram.com/sebas.mvp_official0?igsh=cGk3Zmd0c3Bta280`} 
