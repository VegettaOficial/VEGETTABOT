  ...
  return new Promise((resolve, reject) => {
    axios
      ...
      .then(({data}) => {
        ...
        $("#trends > table.table.table-hover.text-left.clickable.ranking.trends.wider.mb-0 > tbody > tr > td.main > div > span").each(function (
          a,
          b
        ) {
          let deta = $(b).text();
  ...
  return new Promise((resolve, reject) => {
    axios
      ...
      .then(({data}) => {
        ...
        $("div.story-card-data.hidden-xxs > div.story-info > ul > li:nth-child(1) > div.icon-container > div > span.stats-value").each(function (
          e,
          f
        ) {
          let baca = $(f).text();
        ...
        $("div.story-card-data.hidden-xxs > div.story-info > ul > li:nth-child(2) > div.icon-container > div > span.stats-value").each(function (
          g,
          h
        ) {
          let vot = $(h).text();
        ...
        $("div.story-card-data.hidden-xxs > div.story-info > ul > li:nth-child(3) > div.icon-container > div > span.stats-value").each(function (
          i,
          j
        ) {
          let bb = $(j).text();
