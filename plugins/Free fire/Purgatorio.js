...
let pp = purgatorio.getRandom()
const cat = 
`» 𝙈𝘼𝙋𝘼 𝙋𝙐𝙍𝙂𝘼𝙏𝙊𝙍𝙄𝙊  𝙁𝙍𝙀𝙀 𝙁𝙄𝙍𝙀 🔰`
...
let fkontak = { "key": { "participants":"0@s.whats", "remoteJid": "status@broadcast", "fromMe": false, "id": "Halo" }, "message": { "contactMessage": { "vcard": `BEGIN:VCARD\nVERSION:3.0\nN:Sy;Bot;;;\nFN:y\nitem1.TEL;waid=${m.sender.split('@')[0]}:${m.sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD` }}, "participant": "0@s.whatsapp.net" }
